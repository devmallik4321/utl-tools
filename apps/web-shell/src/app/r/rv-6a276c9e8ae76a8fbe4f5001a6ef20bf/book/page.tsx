      ...
      <header className="border-b border-slate-800 bg-slate-900/70 px-4 py-5">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row md:items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2 flex-wrap">
            <a
              href="/r-assets/rv-6a276c9e8ae76a8fbe4f5001a6ef20bf/BOOK-0001-EXTERNAL-REVIEW-PACKAGE.zip"
            ...
            <a
              href="/r-assets/rv-6a276c9e8ae76a8fbe4f5001a6ef20bf/BOOK-0001.pdf"
            ...
            <a
              href="/r-assets/rv-6a276c9e8ae76a8fbe4f5001a6ef20bf/BOOK-0001.epub"
            ...
            <a
              href="/r-assets/rv-6a276c9e8ae76a8fbe4f5001a6ef20bf/cover.jpg"
            ...
            <div className="flex flex-col md:flex-row items-start gap-8">
              ...
              <div className="flex-1 space-y-4">
                <div className="flex items-center justify-between">
                  ...
                  <a
                    href={currentCover?.full_url || "/r-assets/rv-6a276c9e8ae76a8fbe4f5001a6ef20bf/cover.jpg"}
                ...
                <div className="bg-slate-950 border border-slate-800 rounded-xl p-4 flex justify-center items-center overflow-hidden">
                  <img
                    src={currentCover?.full_url || "/r-assets/rv-6a276c9e8ae76a8fbe4f5001a6ef20bf/cover.jpg"}
              ...
              <div className="w-full md:w-80 space-y-6">
                <div className="bg-slate-950 border border-slate-800 rounded-xl p-4 space-y-3">
                  ...
                  <div className="flex justify-center py-2">
                    <img
                      src={currentCover?.thumb_url || "/r-assets/rv-6a276c9e8ae76a8fbe4f5001a6ef20bf/cover_thumb.jpg"}
