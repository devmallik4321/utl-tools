  ...
  return (
    <>
      ...
      <div className="space-y-10 py-4">
        ...
        {/* Tool Header & Search Intent Badge */}
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 pb-4 border-b border-border">
          ...
          <div className="flex items-center gap-2 shrink-0">
            ...
            <ShareButton title={utility.name} />
          </div>
        </div>

        {/* MAIN INTERACTIVE TOOL CANVAS */}
        <section className="bg-card/60 border border-border p-4 sm:p-8 rounded-2xl shadow-sm space-y-4">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 p-4 bg-muted/40 border border-border rounded-xl text-xs text-muted-foreground">
          <div className="flex items-center gap-2.5">
            ...
            <span>
              <strong>Local Browser Execution:</strong> {utility.trustNotes || "All processing occurs 100% locally in your browser sandbox. No inputs are stored or transmitted."}
            </span>
          </div>
          {utility.formula && (
