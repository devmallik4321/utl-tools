...
async function buildControlCenter() {
  ...
  const sheetDefinitions = [
    ...
    { code: "P-01", name: "P-Dashboard", type: "Parent", parent: "P-00 INDEX", desc: "Operational KPIs, live status, counts, session metadata, and system health.", count: "Formula KPIs", target: "A1" },
  ...
  const kpis = [
    ...
    [1, "Platform Status", "PUBLIC_PRODUCTION_READY (AWAITING_GITHUB_PUSH_AND_DNS)", "System Verification", { text: "View Releases", hyperlink: "#'P-Releases'!A1" }],
    ...
    [5, "Total Executable Test Cases", { formula: "COUNTA('C-TestCases'!A5:A100)" }, "C-TestCases Sheet", { text: "View Test Cases", hyperlink: "#'C-TestCases'!A1" }],
    [6, "Tests Passed (100% Rate)", { formula: "COUNTIF('C-TestCases'!J5:J100,\"PASS\")" }, "C-TestCases Status", { text: "Verify Tests", hyperlink: "#'C-TestCases'!A1" }],
    [7, "Failed Tests", { formula: "COUNTIF('C-TestCases'!J5:J100,\"FAIL\")" }, "C-TestCases Status", { text: "Review Fails", hyperlink: "#'C-TestCases'!A1" }],
    [8, "Open P0 Work Tasks", { formula: "COUNTIFS('P-Work'!F5:F100,\"P0\",'P-Work'!G5:G100,\"OPEN\")" }, "P-Work Action Queue", { text: "Open Work Queue", hyperlink: "#'P-Work'!A1" }],
    [9, "Open P1 Work Tasks", { formula: "COUNTIFS('P-Work'!F5:F100,\"P1\",'P-Work'!G5:G100,\"OPEN\")" }, "P-Work Action Queue", { text: "Open Work Queue", hyperlink: "#'P-Work'!A1" }],
    [10, "Pending Human Reviews", "0 (All 47 Approved)", "C-Reviews Matrix", { text: "View Reviews", hyperlink: "#'C-Reviews'!A1" }],
    [11, "Expansion Pipeline Backlog", { formula: "COUNTA('C-Candidates'!A5:A100)" }, "C-Candidates Pipeline", { text: "View Candidates", hyperlink: "#'C-Candidates'!A1" }],
    ...
    [15, "Git Canonical Commit", "471c8d67a13d7fb8f504fa3cb38e073c68ea7dc2 (main)", "Git Head", { text: "View Releases", hyperlink: "#'P-Releases'!A1" }],
    [16, "GitHub Remote Configured", "https://github.com/devmallik4321/utl-tools.git", "Git Config", { text: "View Sessions", hyperlink: "#'P-Sessions'!A1" }],
    ...
    [18, "Production Apex Domain", "https://utl.tools (A: 76.76.21.21, CNAME: cname.vercel-dns.com)", "Vercel Domains", { text: "Open Site", hyperlink: "https://utl.tools" }],
    [19, "Primary Control Artifact", "control/UTL-CONTROL-CENTER.xlsx", "Canonical Master", { text: "Return to Index", hyperlink: "#'P-00 INDEX'!A1" }],
    [20, "Last Verified Build", "Next.js 14 SSG (64 Static Routes Pre-rendered)", "Build Task 425", { text: "View Releases", hyperlink: "#'P-Releases'!A1" }],
  ];
  ...
  utilities.forEach((u, idx) => {
    ...
    const row = wsUtilities.addRow([
      ...
      0,
      "APPROVED",
      "Maintain evergreen state; observe search trend volume",
  ...
  const workItems = [
    ...
    [8, "TSK-0008", "DEPLOY_V1", "CTX-010", "Configure GitHub remote (devmallik4321/utl-tools), link Vercel project, attach utl.tools domains", "P0", "ACCEPTED", "Antigravity CLI", "2026-08-25", "2026-08-25", "Clean Git repository on main at 471c8d6, origin configured, Vercel project linked, domains ready", "TC-0001..TC-0047", { text: "DEPLOYMENT.md", hyperlink: "https://utl.tools" }, { text: "Commit 471c8d6", hyperlink: "https://utl.tools" }, "Awaiting GitHub repo creation & DNS", "Origin set to devmallik4321/utl-tools.git; Vercel project prj_U9CXugQfUbT5IAAttCWIQjqsXBJx configured", "PASS", "Create repo on GitHub, push main, configure DNS A/CNAME records"],
  ];
  ...
  const releaseItems = [
    ...
    [2, "REL-0002", "1.1.0", "2026-08-25", "Public Production Release: 47 Utilities + Value Expansion + Widget Discovery + Canonical Control Center (Commit 471c8d6)", 47, 47, 47, 0, "APPROVED", "PASS (64 Static Pages)", "PUBLIC_RELEASED", { text: "View Changelog ➡️", hyperlink: "#'C-Changes'!A3" }],
  ...
  const contexts = [
    ...
    [2, "CTX-002", "SEO Analyst", "Audit search intent, metadata, Schema.org JSON-LD, and semantic headings", { text: "documentation/SEO-PLAYBOOK.md", hyperlink: "https://utl.tools" }, "Target keywords & search intent", "Structured data & meta tags", "ACTIVE", "2026-08-25", "Validated JSON-LD schema across all 47 tools", "Zero keyword stuffing"],
    ...
    [6, "CTX-006", "UX Analyst", "Optimize layout clarity, accessibility, responsive breakpoints, and contrast", { text: "design-system/DESIGN-SYSTEM.md", hyperlink: "https://utl.tools" }, "Component wireframes & CSS tokens", "Light/Dark theme parity & WCAG AA pass", "ACTIVE", "2026-08-25", "Mobile and desktop verified", "Google simplicity aesthetic"],
  ...
  utilities.forEach((u, idx) => {
    ...
    const row = wsReviews.addRow([
      ...
      u.trustNotes || "100% Client-Side memory",
      ...
      "Implemented and verified in Next.js 14 SSG",
      "PASS",
      "1.1.0",
      "2026-08-25"
    ]);
  ...
  utilities.forEach((u) => {
    ...
    wsChanges.addRow([
      ...
      "Expanded 8-part search destination layout with 100% client-side privacy guarantees",
      "Antigravity CLI"
    ]);
  });
  ...
  utilities.forEach((u, idx) => {
    ...
    const row = wsTestCases.addRow([
      ...
      u.id,
      "TSK-0007",
      `Verify client-side execution, result interpretation, and copy action for ${u.name}`,
      `1. Open ${prodUrl}. 2. Enter test inputs. 3. Verify real-time output computation. 4. Verify interpretation blocks & FAQ. 5. Click Copy.`,
      { text: prodUrl, hyperlink: prodUrl },
      { text: devUrl, hyperlink: devUrl },
      "Instant computation within < 50ms, accurate mathematical/RFC output, successful clipboard copy notification, valid Schema.org tags.",
      "PASS",
